...
//자식 스레드 링크에 연결된 stThreadLink 정보에서 태스크 (tcb)자료구조 위치를 
//계산하여 반환하는 매크로
...
typedef struct kTCBPoolManagetStruct
{
	//태스크 풀에 대한 정보
	TCB* pstStartAddress;
	int iMaxCount;
...
typedef struct kSchedulerStruct
{
	...
	//현재 수행 중이 ㄴ태스크가 사용할 수 있는 프로세서 시간
	int iProcessorTime;

	//실행할 테스크가 준비 중인 리스트, 태스크의 우선순위에 따라 구분
